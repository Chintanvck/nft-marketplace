        ...
        <div className={Style.navbar_container}>
          ...
          <div className={Style.navabr_container_right}>
            ...
            <div className={Style.navbar_container_right_notify}>
              <MdNotifications className={Style.navabr_container_right_notify} onClick={() => openNotification()} />
            ...
            <div className={Style.navabr_container_right_profile_box}>
              <div className={Style.navabr_container_right_profile}>
                <Image src={images.user1} alt='Profile' width={40} height={40} onClick={() => openProfile()} className={Style.navabr_container_right_profile} />
                {profile && <Profile />}
              </div>
            </div>
